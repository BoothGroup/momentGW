"""Spin-unrestricted self-consistent GW via self-energy moment constraints for molecular systems."""
...
class scUGW(UGW, scGW):
    """Spin-unrestricted self-consistent GW via self-energy moment constraints for molecules.
